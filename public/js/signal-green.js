...
const Game = {
    ...
    translations: {
        en: {
            ...
            ruleObjTitle: "Objective",
            ruleObjDesc: "Manage the intersection traffic and AVOID COLLISIONS!",
            rule1Title: "Regular Traffic",
            rule1Desc: "Tap a moving car to STOP / HOLD it. Tap again to GO.",
            rule2Title: "Speed Boost",
            rule2Desc: "Swipe/flick a vehicle forward to BOOST it across the junction.",
            rule3Title: "Emergency Vehicles",
            rule3Desc: "Ambulances CANNOT BE STOPPED. Prioritize their path immediately!",
        ...
        ml: {
            ...
            ruleObjTitle: "ലക്ഷ്യം",
            ruleObjDesc: "വണ്ടികൾ കൂട്ടിയിടിക്കാതെ ട്രാഫിക് നിയന്ത്രിക്കുക!",
            rule1Title: "സാധാരണ വണ്ടികൾ",
            rule1Desc: "ഓടുന്ന വണ്ടികളിൽ തൊട്ടാൽ നിൽക്കും. വീണ്ടും തൊട്ടാൽ പോകും.",
            rule2Title: "വേഗത കൂട്ടുക",
            rule2Desc: "വണ്ടികൾ വേഗത്തിൽ വിടാൻ അവയെ മുന്നിലേക്ക് സ്വൈപ്പ് ചെയ്യുക.",
            rule3Title: "ആംബുലൻസുകൾ",
            rule3Desc: "ആംബുലൻസുകൾ നിർത്താൻ കഴിയില്ല. അവയ്ക്ക് ആദ്യം വഴി നൽകുക!",
